# Generated by Django 2.2 on 2020-04-28 21:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('gr', '个人'), ('gx', '高校')], default='', max_length=10, verbose_name='机构类别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliations', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizations.CourseOrg', verbose_name='所属机构')),
